...
body {
    ...
    min-height: 100vh;
    background:
        radial-gradient(circle at 50% 20%, #06252d 0%, #02090c 35%, #000 75%);
    color: #dffcff;
...
.core {
    ...
    height: 75px;
    border-radius: 50%;
    background: radial-gradient(circle, #dfffff 0%, #00eaff 35%, #007b8a 65%, #00252b 100%);
    box-shadow:
        0 0 20px #00eaff,
        0 0 50px rgba(0, 234, 255, 0.8);
    display: flex;
    justify-content: center;
    align-items: center;
...
.chat-section {
    ...
    border-radius: 14px;
    padding: 15px;
    background: rgba(0, 15, 19, 0.75);
    box-shadow: 0 0 30px rgba(0, 234, 255, 0.05);
}
